...
@Client.on_message(
    command(["المساعد","userbotjoin", f"userbotjoin@{BOT_USERNAME}"]) & ~filters.private & ~filters.bot
)
...
@Client.on_message(command(["غادركبد","userbotleave",
...
@Client.on_message(command(["غادرالكل","leaveall", f"leaveall@{BOT_USERNAME}"]))
@sudo_users_only
